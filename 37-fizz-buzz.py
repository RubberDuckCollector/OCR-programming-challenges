...
def check_prime(n):
    ...
    if n == 1:
        ...
        for i in range(2, n):
            if n % i == 0:
                return False # this is false because if n is divisible y i, then it must have more than 2 factors (which would be more than 1 and itself, meaning that n is not prime)
